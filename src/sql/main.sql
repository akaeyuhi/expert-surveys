...
CREATE TABLE IF NOT EXISTS `ExpertSurveys`.`Answer` (
  ...
  INDEX `fk_Answers_Experts_idx` (`Expert_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ExpertSurveys`.`SurveyAction` (
  ...
  `at` DATE NULL,
  `Survey_id` INT NOT NULL,
  `SurveyState_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_SurveyAction_Surveys1_idx` (`Survey_id` ASC) VISIBLE,
  INDEX `fk_SurveyAction_SurveyState1_idx` (`SurveyState_id` ASC) VISIBLE,
  CONSTRAINT `fk_SurveyAction_Surveys1`
    FOREIGN KEY (`Survey_id`)
    REFERENCES `ExpertSurveys`.`Survey` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SurveyAction_SurveyState1`
    FOREIGN KEY (`SurveyState_id`)
    REFERENCES `ExpertSurveys`.`SurveyState` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
